...
<body class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
    <div class="flex w-full max-w-5xl bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <!-- Image Section -->
        <div class="hidden md:block md:w-1/2 bg-cover bg-center" style="background-image: url('pics/doctor1.png')">
        </div>
        ...
        <div class="w-full md:w-1/2 p-8">
            <div class="text-center mb-6">
                ...
                <h2 class="text-2xl font-bold mt-2">MedShare<br> System</h2>
                <br>
